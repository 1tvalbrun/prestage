...
type TypedFormProps = {
  pack: DomainPack
  // The practice's shape for the current scope, resolved by the page.
...
export const TypedForm = ({
  ...
  const handleSubmit = () => {
    const gaps = missingRequired(variant.scopeFields, form.scope)
  ...
  return (
    <div
      className={cn(
        ...
        variant.copy.preview
          ? "max-w-[1060px] grid-cols-[minmax(0,1fr)_360px]"
    ...
    >
      ...
      >
          ...
          {variant.copy.formSections.map((section) => (
